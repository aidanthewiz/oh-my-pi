...
# terminal transcript.
#
# Prepare a directory (default ~/coreforge-signing) containing:
...
#   CF_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/coreforge-signing
...
DIR="${DIR:-${CF_SIGNING_DIR:-$HOME/coreforge-signing}}"
REPO="${CF_REPO:-Coreforce-CAD/oh-my-pi}"
