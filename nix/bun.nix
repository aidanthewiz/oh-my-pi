...
}:
{
  ...
  "@azure/msal-common@16.11.1" = fetchurl {
    url = "https://registry.npmjs.org/@azure/msal-common/-/msal-common-16.11.1.tgz";
    hash = "sha512-yPohvMwWLv1XnaWnIUyKUh8CvcVChCGqG/VluGwfGmaAfrZTNt5yQ+sIs462Sgw6+e2K83KGmMJ860p73ZSCrw==";
  };
  "@azure/msal-node@5.4.0" = fetchurl {
    url = "https://registry.npmjs.org/@azure/msal-node/-/msal-node-5.4.0.tgz";
    hash = "sha512-6EZEParwHRlnSSIikw8FNAnAzwmh71uhveUXdPNFeZFviJ9SH+rwFiurhjzXqICYTrpm3E+dj693QOwfPbJXAQ==";
  };
  ...
  "@oh-my-pi/pi-diagram" = copyPathToStore ../packages/diagram;
  ...
  "@oh-my-pi/relay" = copyPathToStore ../packages/relay;
