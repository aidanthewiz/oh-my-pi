...
stdenv.mkDerivation {
  ...
  meta = {
    description = "Coreforge coding agent";
    homepage = "https://github.com/Coreforce-CAD/oh-my-pi";
    changelog = "https://github.com/Coreforce-CAD/oh-my-pi/releases/tag/v${packageJson.version}";
