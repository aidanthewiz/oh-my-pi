 ...
 * author with a local identicon, parents, and the commit's file list.
 *
 ...
 */
import { Editor, Input, matchesKey, truncateToWidth, visibleWidth } from "@oh-my-pi/pi-tui";
import { getEditorTheme, theme } from "../../modes/theme/theme";
import { identiconLines } from "./avatar";
...
export class Sidebar {
	...
	#avatarRows(email: string): string[] {
		return identiconLines(email, (hex, text) => {
