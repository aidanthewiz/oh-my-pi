...
export function getExtraHelpText(): string {
  ...
  Use \`${CF_COMMAND} --profile <name> --alias <command>\` to create a shell shortcut for a profile
...
${chalk.bold("Available Tools (default-enabled unless noted):")}
  ...
  python        - Execute Python code (requires: ${CF_COMMAND} setup python)
...
${chalk.bold("Useful Commands:")}
  ${CF_COMMAND} agents unpack           - Export bundled subagents to ~/.omp/agent/agents (default)
  ${CF_COMMAND} agents unpack --project - Export bundled subagents to ./.omp/agents`;
}
