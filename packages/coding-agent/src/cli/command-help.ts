...
export const acpHelp = {
	description: "Run Coreforge as an ACP (Agent Client Protocol) server over stdio",
} satisfies CommandMetadata;

export const agentsHelp = { description: "Manage bundled task agents" } satisfies CommandMetadata;

export const authBrokerHelp = {
	description: "Manage the Coreforge auth broker (credential vault)",
} satisfies CommandMetadata;
...
export const clipHelp = {
	description: "Upload a /record recording to the configured stream server as a public clip and print its URL",
} satisfies CommandMetadata;
...
export const mcpHelp = { description: "Configure MCP server selections" } satisfies CommandMetadata;
...
export const relayHelp = { description: "Approve a browser for Coreforce Agent Collab" } satisfies CommandMetadata;
