...
interface BrowserAppOptions {
	/** Absolute or cwd-relative browser/Electron executable to spawn. Chromium-family browsers launch on a Coreforge-owned profile unless `args` sets `--user-data-dir`. */
	path?: string;
