...
- Preserved Claude Platform on AWS authentication when `ANTHROPIC_BASE_URL` reroutes the stock Anthropic provider, including workspace headers and credential-family isolation.
