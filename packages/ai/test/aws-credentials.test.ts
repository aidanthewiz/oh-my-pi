...
describe("resolveAwsCredentials SSO token refresh", () => {
	...
	beforeEach(async () => {
		...
		// Exercise the built-in refresh fallback rather than Coreforge's preferred
		// AWS CLI credential exporter.
		Bun.env.PATH = tmp;
		// The resolver honors HOME before falling back to os.homedir().
