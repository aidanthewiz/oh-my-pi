...
export declare class VcsGitRepo {
  ...
  fetch(remote: string, source: string, target: string, timeoutMs?: number | undefined | null, signal?: unknown | undefined | null, environment?: Record<string, string> | undefined | null): Promise<void>
}
