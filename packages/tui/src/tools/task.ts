...
/** Controls which instruction files are forwarded to a child agent. */
...
export interface TaskItem {
	...
	/** Instruction-file forwarding policy for this child. */
...
export interface TaskParams {
	...
	/** Validation behavior for a caller-provided or inherited output schema. */
	schemaMode?: "permissive" | "strict";
	/** Instruction-file forwarding policy for the flat-form child. */
	contextFilePolicy?: ContextFilePolicy;
