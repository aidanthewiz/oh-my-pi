...
export class Composer implements TerminalFrameProvider {
	...
	updateWelcome(update: ComposerWelcomeUpdate): void {
		...
		if (update.productName !== undefined || update.greetingName !== undefined) {
			welcome.setIdentity(this.#productName, this.#greetingName);
		}
	...
	#applyWelcomeUpdate(update: ComposerWelcomeUpdate): void {
		...
		if (update.productName !== undefined) this.#productName = update.productName;
		if (update.greetingName !== undefined) this.#greetingName = update.greetingName;
