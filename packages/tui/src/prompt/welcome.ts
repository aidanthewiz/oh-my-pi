...
/**
 * Premium welcome screen with a product mark and two-column layout.
 */
export class WelcomeComponent implements Component {
	...
	constructor(
		...
		private productName: string = APP_NAME,
	...
	setIdentity(productName: string, greetingName?: string): void {
	...
	#welcomeText(): string {
		return this.greetingName ? `Welcome back, ${this.greetingName}!` : "Welcome back!";
	}
	...
	#renderLines(termWidth: number): string[] {
		...
		const versionLabel = `${this.productName} v${this.version}`;
