...
//!
//! Git CLI fallbacks are reserved for credential-bound network transfers,
//! configured commit signing and hooks, and reftable repositories. The
//! remaining operations run in-process.
//!
