...
mod tests {
	...
	#[tokio::test]
	async fn stage_hunks_commit_split_survives_unadvanced_index_mtime() {
		...
		crate::git::pin_index_mtime(&repo);
		repo
			.commit_create("feat: add new file", &crate::types::CommitOptions::default(), None)
			.await
		...
		crate::git::pin_index_mtime(&repo);
		repo
			.commit_create("fix: update tracked file", &crate::types::CommitOptions::default(), None)
			.await
